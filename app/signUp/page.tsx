...
const SignUp = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#104C98]">
            <div className="bg-white p-10 rounded-lg shadow-lg w-[420px]">
                ...
                <form onSubmit={handleSignup} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        className="w-full py-3 bg-[#104C98] text-white rounded-lg hover:bg-[#083A73] transition duration-300"
                    >
                        Sign up
                    </button>
                </form>
                ...
                <p className="text-gray-600 text-center mt-4">
                    ...
                    <Link href="/login" className="text-[#104C98] font-semibold hover:underline">
                        Login here
                    </Link>
                </p>
            </div>
